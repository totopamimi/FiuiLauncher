...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        boolean customWorkspaceEnabled = resources
                .getBoolean(R.bool.custom_workspace_enabled);
        int fourByFourDefaultLayout = customWorkspaceEnabled ? R.xml.fiui_workspace_4x4
