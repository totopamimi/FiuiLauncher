...
public interface BackupProtos {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case com.android.launcher3.backup.BackupProtos.Key.FAVORITE:
              case com.android.launcher3.backup.BackupProtos.Key.SCREEN:
              case com.android.launcher3.backup.BackupProtos.Key.ICON:
              case com.android.launcher3.backup.BackupProtos.Key.WIDGET:
                this.type = value;
                break;
            }
            break;
  ...
  public static final class Journal extends
    ...
    public com.android.launcher3.backup.BackupProtos.DeviceProfieData profile;
    ...
    public Journal mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 58: {
            if (this.profile == null) {
              this.profile = new com.android.launcher3.backup.BackupProtos.DeviceProfieData();
            }
